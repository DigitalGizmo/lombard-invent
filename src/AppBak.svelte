...
<main>
  ...
  <div class="image-panel-fixed">
    <div class="image-panel-image">
      ...
      <div class="hauler-container">
        <img  src="images/lumber.png" class="overlaying-image"
          width="280px" alt="lumber"/> 

        <div  style="transform:translate(20vh, 15vh)">
          {#if challengeIndex === -1}
            <img src="images/horses.png" width="300px" alt="horses"/>
          {:else if challengeIndex === 0}
            <img src="images/horses-kaput.png" width="50%" alt="kaput"/>
          {/if}
        </div>
      </div>
      {#if challengeIndex === 0}
        <div  style="transform:translate(20vw, 20vh)">
          ...
          />
          <img src="images/option-trolly.png"  width="10%" alt="trolly"
